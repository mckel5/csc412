...
void* remove_first(node_t** head_list) {
    ...
    *head_list = (*head_list)->next;
    ...
    // void* data = malloc(sizeof(curr->data));
    // void* data[sizeof curr->data];
    // memcpy(data, &(curr->data), sizeof(curr->data));
    void* data = curr->data;
